...
class CustomerResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\Section::make('Costumer Details')
                    ->schema([
                ...
                Forms\Components\Section::make('Lead Details')
                        ->schema([
                            Forms\Components\Select::make('lead_source_id')
                                // Suggested code may be subject to a license. Learn more: ~LicenseLog:4247907464.
        ...
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('first_name')
                    ...
                    ->formatStateUsing(function ($record) {
                        $tagList = view('customer.tagsList', ['tags' => $record->tags])->render();
                        return $record->first_name . ' ' . $record->last_name . ' ' . $tagList;
                    })
                    ->html()
                    ->searchable(['first_name', 'last_name']),
